...
import ru.tiktaktoe.repository.PlayerRepo;
...
public class GamePlayCalcTest {
    ...
    public void setUp(){
        ...
        Mockito.when(gameInstanceRepo.findById(1).get()).thenReturn(gameInstance);
    ...
    public void testNewGameCreation(){
        ...
        Player player2 = new Player("testPlayer2");
        Mockito.when(gameInstanceRepo.findById(anyInt()).get()).thenReturn(gameInstance);
